(() => {
    ...
    (() => {
        ...
        function map(n) {
            ...
            var locations = [ [ new google.maps.LatLng(54.994433114437335, 82.87840982037264) ] ];
            var options = {
                zoom: 11,
                panControl: false,
        ...
        function initSliders() {
            if (document.querySelector(".main-slider-page__slider")) new core(".main-slider-page__slider", {
            ...
            if (document.querySelector(".equipment-page__slider")) new core(".equipment-page__slider", {
                ...
                pagination: {
                    el: ".controll-equipment__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: "._icon-arrow-left-big",
                    nextEl: "._icon-arrow-right-big"
                },
                on: {
                    init: function(swiper) {
                        const allSlides = document.querySelector(".fraction-controll__all");
                        const allSlidesItems = document.querySelectorAll(".equipment__slide:not(.swiper-slide-duplicate)");
            ...
            if (document.querySelector(".viewed-page__slider")) new core(".viewed-page__slider", {
            ...
            if (document.querySelector(".similar-content-product__slider")) new core(".similar-content-product__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".similar-content-product__arrow_left",
                    nextEl: ".similar-content-product__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        document.querySelector(".content-category-page__header");
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
